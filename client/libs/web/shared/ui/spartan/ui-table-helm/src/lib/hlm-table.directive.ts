...
export class HlmTableDirective {
  ...
  readonly userVariant = input<Partial<HlmTableVariant> | string>(
    {},
    { alias: "hlmTable" }
  );
...
export class HlmTHeadDirective {
  ...
  protected readonly _computedClass = computed(() =>
    hlm(
      this._globalOrDefaultConfig ? this._globalOrDefaultConfig.thead.trim() : "",
      this.userClass()
    )
  );
}
...
export class HlmTBodyDirective {
  ...
  protected readonly _computedClass = computed(() =>
    hlm(
      this._globalOrDefaultConfig ? this._globalOrDefaultConfig.tbody.trim() : "",
      this.userClass()
    )
  );
}
...
export class HlmTFootDirective {
  ...
  protected readonly _computedClass = computed(() =>
    hlm(
      this._globalOrDefaultConfig ? this._globalOrDefaultConfig.tfoot.trim() : "",
      this.userClass()
    )
  );
}
...
export class HlmCaptionDirective {
  ...
  protected readonly _computedClass = computed(() =>
    hlm(
      this._globalOrDefaultConfig ? this._globalOrDefaultConfig.caption.trim() : "",
      this.userClass()
    )
  );
}
