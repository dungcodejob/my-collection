...
export class HlmToasterComponent {
  ...
  public readonly richColors = input<ToasterProps["richColors"], boolean | string>(
    false,
    {
      transform: booleanAttribute,
    }
  ...
  public readonly visibleToasts = input<ToasterProps["visibleToasts"], number | string>(
    3,
    {
      transform: numberAttribute,
    }
  );
  public readonly closeButton = input<ToasterProps["closeButton"], boolean | string>(
    false,
    {
      transform: booleanAttribute,
    }
