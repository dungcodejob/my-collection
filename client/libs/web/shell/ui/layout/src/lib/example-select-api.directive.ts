...
import {
  MCApiSelectFacade,
  provideApiSelectFacade,
  SelectOption,
} from "@client/web-shared-ui-select";
...
@Directive({
  ...
  providers: [provideApiSelectFacade(ExampleSelectApiDirective)],
})
export class ExampleSelectApiDirective extends MCApiSelectFacade<ExampleFilter> {
